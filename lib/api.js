...
class Api {
    ...
    */
    async UserLogin(Username = String(), Password = String()){
        const response = await this.app.post('/?ng=api.underdecklib', new URLSearchParams({ _lang: this.#LanguageId, Method: 'UserLogin', Username: Username, Password: Password }));
    ...
    */
    async UserAuth(Token = String()){
        const response = await this.app.post('/?ng=api.underdecklib', new URLSearchParams({ _lang: this.#LanguageId, Method: 'UserAuth', Token: Token }));
        return response?.data?.user && response.data.user.id ? new Models.User(response.data.user) : null;
    }
    ...
    */
    async Request(Data = Object()){
        ...
        formData.append('_lang', this.#LanguageId);
